...
public class DateUtil {
	 ...
	 * @return
	 */
	public static final long getUnixFormatDateTime(String dateString){
		Date date = parseDateTime(dateString);
		return (date==null?(new Date()).getTime():date.getTime() )/1000;
	}
	
	public static final long getCurrentUnixFormatDateTime(){
